    ...
    <div class="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-md my-2 ">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead>
                    <tr>
                        <th class="px-6 py-2 text-normal font-medium bg-gray-200">Id</th>
                        <th class="px-6 py-2 text-normal font-medium bg-gray-200">Name Formatting</th>
                        <th class="px-6 py-2 text-normal font-medium bg-gray-200">Type Formatting</th>
                        <th class="px-6 py-2 text-normal font-medium bg-gray-200">Progress</th>
                        <th class="px-6 py-2 text-normal font-medium text-end bg-gray-200"></th>
                    </tr>
                </thead>
                <tbody class="divide-y">
                    @foreach($formatting as $format)
                        <tr>
                            ...
                            <td class="px-6 py-2 whitespace-nowrap">{{ $format->types->name }}</td>
